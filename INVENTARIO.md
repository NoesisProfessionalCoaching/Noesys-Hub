...
- `server/routes.js`: **3694 righe**, **92 rotte**; `server/pagine/`: **6 file**, **6155 righe**, **15 pagine**
...
- `cercaPage` (pagine/clienti.js, riga 2260)
- `icfPage` (pagine/clienti.js, riga 2342)
